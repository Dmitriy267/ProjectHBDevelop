...
import styles from './CarouselHotHomeMainPage.module.scss';
import arrowRight from '../../../image/mainPage/Sliders/Group 652.svg';
const MAIN_PAGE_WIDTH:string='407px';
const CarouselHotHomeMainPage=({children}:{children: any})=>{
...
export {CarouselHotHomeMainPage}