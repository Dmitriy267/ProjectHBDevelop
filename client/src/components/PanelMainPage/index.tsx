...
<li className={togglState===1? clsx(styles.active__li, styles.tabs__li): styles.tabs__li} onClick={()=>toggleTab(1)}>Квартиры на сутки</li>
<li className={togglState===2? clsx(styles.active__li, styles.tabs__li): styles.tabs__li} onClick={()=>toggleTab(2)}>Коттеджи и усадьбы</li>
<li className={togglState===3? clsx(styles.active__li, styles.tabs__li): styles.tabs__li} onClick={()=>toggleTab(3)}>Бани и сауны</li>
<li className={togglState===4? clsx(styles.active__li, styles.tabs__li): styles.tabs__li} onClick={()=>toggleTab(4)}>Авто напрокат</li>
    </ul>
